---
title: "Uniendo y separando columnas con tidyr"
description: |
  Rstudio Certification exam - Teaching
author:
  - name: Roxana Noelia Villafañe 
    url: https://roxananoelia.netlify.app/
    affiliation: Universidad Nacional del Nordeste
    affiliation_url: 
date: "`r Sys.Date()`"
...
library(metathis)
meta() %>%
  meta_name("github-repo" = "data-datum/tidyr") %>% 
  meta_social(
    title = "Ordenando datos con tidyr",
    description = paste(
      "clase de Rstudio Certification" ,
      "Slides de Roxana Noelia"
    ),
    url = "https://data-datum.github.io/tidyr/clase.html",
    image = "https://github.com/data-datum/tidyr/img/share-card.png",
    image_alt = paste(
      "First slide of",
      "Ordenando datos con tidyr",
      "Clase de Rstudio Certification exam" ,
      "Creado por Roxana Villafañe"
    ),
    og_type = "website",
    og_author = "Roxana Noelia Villafañe",
    twitter_card_type = "summary_large_image",
    twitter_creator = "@data_datum"
  )
```
...
Eugenia es ingeniera agrónoma y está haciendo su maestría en producción vegetal. Realiza trabajos mayormente en el campo y no es muy amiga de las computadoras. Es profesora en la materia “Citricultura” de la carrera de Ingeniería agronómica. Sabe usar infostat que es una IDE para análisis estadístico simple y Excel, además de Word y Powerpoint. Le interesa R para hacer cálculos de modelos mixtos para sus experimentos. No tiene nada de experiencia en programación. También le interesa aprender a hacer gráficos para poder publicar los trabajos de su maestría.
...
<p style="text-align:right;">[<i class="fas fa-external-link-alt"></i> Open full page](https://data-datum.github.io/tidyr/clase.html)</p>
